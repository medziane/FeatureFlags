...
/// <summary>
///     A feature flag that is enabled when all of the given feature flags are disabled.
/// </summary>
public class EnabledWhenAllDisabledFeatureFlag :
    FeatureFlag
{
    /// <summary>
    ...
    /// <returns><c>true</c> if all of the <paramref name="featureFlags" /> are disabled. Otherwise, <c>false</c>.</returns>
