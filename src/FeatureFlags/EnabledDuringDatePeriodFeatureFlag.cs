...
/// <summary>
///     A feature flag that is enabled during a given date period.
/// </summary>
public class EnabledDuringDatePeriodFeatureFlag :
    FeatureFlag
{
    /// <summary>
    ///     Create a new instance of the <see cref="EnabledDuringDatePeriodFeatureFlag" /> class.
    /// </summary>
    /// <param name="datePeriod">The date range representing the period in which this feature flag is enabled.</param>
