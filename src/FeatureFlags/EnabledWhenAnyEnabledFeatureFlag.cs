...
/// <summary>
///     A feature flag that is enabled when any of the given feature flags is enabled.
/// </summary>
public class EnabledWhenAnyEnabledFeatureFlag :
    FeatureFlag
{
    /// <summary>
    ///     Creates a new instance of the <see cref="EnabledWhenAnyEnabledFeatureFlag" /> class.
    /// </summary>
    ...
    /// <returns><c>true</c> if any of the <paramref name="featureFlags" /> is enabled. Otherwise, <c>false</c>.</returns>
